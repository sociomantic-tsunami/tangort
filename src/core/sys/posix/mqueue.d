 ...
 * mqd_t mq_open(char* name, int oflag, mode_t mode, mq_attr* attr);
 *
 * Params:
 ...
 *   set to indicate the error.
 */
int mq_setattr (mqd_t mqdes, mq_attr* newstat, mq_attr* oldstat);
...
ssize_t mq_timedreceive (mqd_t mqdes, char* msg_ptr, size_t msg_len,
                         uint* msg_prio, timespec* abs_timeout);
 ...
 *
 */
int mq_timedsend (mqd_t mqdes, char* msg_ptr, size_t msg_len,
                   uint msg_prio, timespec* abs_timeout);
