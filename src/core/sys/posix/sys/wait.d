...
{
	const WCONTFLG		= Octal!("0177777");

    const WNOHANG       = Octal!("0100");
    const WUNTRACED     = Octal!("0004");
	const WCONTINUED	= Octal!("0010");
    ...
    {
        return (status & 0xFF) == Octal!("177") && (status & 0xFF00) != 0;
    }
