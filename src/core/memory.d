...
struct GC
{
     ...
     */
    static void monitor( void delegate() begin,
                         void delegate(int freed, int pagebytes) end )
    {
    ...
    */
    ...
    /**
     * Writes the current memory usage and the free memory in bytes
     * left in the pool.
     *
     * If both returned values are 0, it means this feature is not implemented
     * in the current GC being used.
     *
     * Params:
     *      used = memory used in the program
